...
/**
 * Establishes comprehensive chapter card with contact details and quick action overlay.
 * Implements accessible hover interactions and expandable leadership information.
 *
 * Best for: Chapter overview with immediate access to contact information and common actions
 *
...
export function ChapterCard({
  ...
  return (
    <Card
      ...
      role="article"
      aria-label={`${chapter.name} chapter card`}
    >
